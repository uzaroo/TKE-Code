...
recordcount;
selectedProduct;
// Wire adapter to fetch data based on search term
@wire(graphql, {
    query: '$pricebookentryquery',
    variables:'$getSearchVariable'
})
wiredProducts({ error, data }) {
    ...
    if (data) {
        ...
        {
          this.recordcount=data.uiapi.query.PricebookEntry.edges.length;
...
get getSearchVariable()
{
  var searchTermValue={ searchTerm: `%${this.searchTerm}%` };//   "%muntz%";
